...
export default function HeroSection() {
  ...
  return (
    ...
    <section
      ...
      className="relative flex items-center justify-center h-screen w-full overflow-hidden bg-[rgb(var(--color-background))]"
    >
      ...
      {/* Dark Overlay */}
      <div aria-hidden="true" className="absolute inset-0 bg-[rgb(var(--color-background))/0.5]" />{" "}
      {/* Text Content Container */}
      <div className="relative z-10 text-center text-[rgb(var(--color-foreground))] px-4">
        {/* Main Heading */}
